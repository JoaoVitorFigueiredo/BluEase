...
class Andar1(App):
    def build(self):
        ...
        self.spot_buttons = {}  # Dictionary to keep track of spot buttons
        ...
        for spot in building.get_spots():
            ...
            self.spot_buttons[spot.get_name()] = spot_button  # Store the button in the dictionary
    ...
    def change_button_color(self, spot_name, new_icon):
        if spot_name in self.spot_buttons:
            button = self.spot_buttons[spot_name]
            button.background_normal = new_icon
            button.background_down = new_icon
...
if __name__ == '__main__':
    ...
    # Change the color of a button dynamically
Andar1().change_button_color("Receção", "rsz_1interestpoint_red.png")
